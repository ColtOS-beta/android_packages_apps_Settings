...
class coltInfoPreferenceController(context: Context) : AbstractPreferenceController(context) {
    ...
    companion object {
        ...
        private const val PROP_COLT_VERSION = "ro.modversion"
        private const val PROP_COLT_RELEASETYPE = "ro.colt.releasetype"
        private const val PROP_COLT_MAINTAINER = "ro.colt.build.maintainer"
        private const val PROP_COLT_DEVICE = "ro.colt.device"
        private const val PROP_COLT_BUILD_TYPE = "ro.colt.build.type"
